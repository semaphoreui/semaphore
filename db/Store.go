...
type UserManager interface {
	...
	// ImportUser creates a user while preserving the existing password hash.
	// Unlike CreateUser, which expects a plaintext password and computes a new hash,
	// ImportUser should be used only for migration or import flows where the
	// password hash has already been generated by another system and must not
	// be changed.

...
create table session_new_2_20_2 (
...
insert into task_new_2_20_2 (id, template_id, status, playbook, environment, created, start, `end`, user_id, project_id, message, version, commit_hash, commit_message, build_task_id, arguments, inventory_id, integration_id, schedule_id, git_branch, params, runner_id, workflow_run_id, workflow_node_id, artifacts)
...
alter table task_new_2_20_2 rename to task;

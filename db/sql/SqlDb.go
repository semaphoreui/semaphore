...
func (d *SqlDb) Connect(token string) {
	...
	d.sql.AddTableWithName(db.Integration{}, "integration").SetKeys(true, "id")
	d.sql.AddTableWithName(db.IntegrationExtractor{}, "integrationextractor").SetKeys(true, "id")
	d.sql.AddTableWithName(db.IntegrationMatcher{}, "integrationmatcher").SetKeys(true, "id")
	d.sql.AddTableWithName(db.IntegrationExtractValue{}, "integrationextractvalue").SetKeys(true, "id")
...
// Retrieve the Matchers & Values referncing `id' from IntegrationExtractor
// --
// Examples:
...
// //
//
// referrerCollection := db.IntegrationExtractorReferrers{}
//
//	d.GetReferencesForForeignKey(db.IntegrationProps, id, map[string]db.ObjectProps{
//	  "Matchers": db.IntegrationMatcherProps,
//	  "Values": db.IntegrationExtractValueProps
//	}, &referrerCollection)
...
// Example:
// GetObjectReferences(db.IntegrationMatchers, db.IntegrationExtractorProps, extractorID)

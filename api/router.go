...
func Route() mulekick.Router {
	...
	func(api mulekick.Router) {
		...
		api.Post("/users/{user_id}/launchonly", projects.MustBeAdmin, projects.UserMiddleware, projects.MakeUserLaunchOnly)
		api.Delete("/users/{user_id}/launchonly", projects.MustBeAdmin, projects.UserMiddleware, projects.MakeUserLaunchOnly)
		...
		api.Put("/keys/{key_id}", projects.MustBeNotLaunchOnly, projects.KeyMiddleware, projects.UpdateKey)
		api.Delete("/keys/{key_id}", projects.MustBeNotLaunchOnly, projects.KeyMiddleware, projects.RemoveKey)

		api.Get("/repositories", projects.GetRepositories)
		api.Post("/repositories", projects.AddRepository)
		api.Put("/repositories/{repository_id}", projects.MustBeNotLaunchOnly, projects.RepositoryMiddleware, projects.UpdateRepository)
		api.Delete("/repositories/{repository_id}", projects.MustBeNotLaunchOnly, projects.RepositoryMiddleware, projects.RemoveRepository)

		api.Get("/inventory", projects.GetInventory)
		api.Post("/inventory", projects.AddInventory)
		api.Put("/inventory/{inventory_id}", projects.MustBeNotLaunchOnly, projects.InventoryMiddleware, projects.UpdateInventory)
		api.Delete("/inventory/{inventory_id}", projects.MustBeNotLaunchOnly, projects.InventoryMiddleware, projects.RemoveInventory)

		api.Get("/environment", projects.GetEnvironment)
		api.Post("/environment", projects.AddEnvironment)
		api.Put("/environment/{environment_id}", projects.MustBeNotLaunchOnly, projects.EnvironmentMiddleware, projects.UpdateEnvironment)
		api.Delete("/environment/{environment_id}", projects.MustBeNotLaunchOnly, projects.EnvironmentMiddleware, projects.RemoveEnvironment)

		api.Get("/templates", projects.GetTemplates)
		api.Post("/templates", projects.AddTemplate)
		api.Put("/templates/{template_id}", projects.MustBeNotLaunchOnly, projects.TemplatesMiddleware, projects.UpdateTemplate)
		api.Delete("/templates/{template_id}", projects.MustBeNotLaunchOnly, projects.TemplatesMiddleware, projects.RemoveTemplate)

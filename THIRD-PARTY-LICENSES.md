...
| `github.com/coreos/go-oidc/v3` | v3.18.0 | Apache-2.0 | [link](https://github.com/coreos/go-oidc/blob/v3.18.0/LICENSE) |
...
| `github.com/go-git/go-git/v5` | v5.19.1 | Apache-2.0 | [link](https://github.com/go-git/go-git/blob/v5.19.1/LICENSE) |
...
| `github.com/go-ldap/ldap/v3` | v3.4.13 | MIT | [link](https://github.com/go-ldap/ldap/blob/v3.4.13/v3/LICENSE) |
...
| `golang.org/x/crypto` | v0.53.0 | BSD-3-Clause | [link](https://cs.opensource.google/go/x/crypto/+/v0.53.0:LICENSE) |
| `golang.org/x/net` | v0.56.0 | BSD-3-Clause | [link](https://cs.opensource.google/go/x/net/+/v0.56.0:LICENSE) |
| `golang.org/x/oauth2` | v0.36.0 | BSD-3-Clause | [link](https://cs.opensource.google/go/x/oauth2/+/v0.36.0:LICENSE) |
| `golang.org/x/sys` | v0.46.0 | BSD-3-Clause | [link](https://cs.opensource.google/go/x/sys/+/v0.46.0:LICENSE) |
| `golang.org/x/term` | v0.44.0 | BSD-3-Clause | [link](https://cs.opensource.google/go/x/term/+/v0.44.0:LICENSE) |
...
| `modernc.org/libc` | v1.73.1 | MIT | [link](https://gitlab.com/cznic/libc/blob/v1.73.1/LICENSE-3RD-PARTY.md) |
...
| `modernc.org/sqlite` | v1.52.0 | BSD-3-Clause | [link](https://gitlab.com/cznic/sqlite/blob/v1.52.0/LICENSE) |
...
| `cron-parser` | 5.5.0 | MIT | [link](https://github.com/harrisiirak/cron-parser) |

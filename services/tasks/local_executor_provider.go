...
func (p *LocalExecutorProvider) NewExecutor(task db.Task, template db.Template, inventory db.Inventory, repository db.Repository, submoduleCredentials []db.RepositorySubmoduleCredential, environment db.Environment, jwt string) (Executor, error) {

export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: '먼저 Forge가 실행되는 서버에 대한 액세스가 필요합니다.',
  ...
  projectBuilder: '프로젝트 빌더',
  additionalOptions: '추가 옵션',
  importScripts: '스크립트 가져오기',
  jumpbox: '점프박스',
  jumpboxStigCompliant: '점프박스 STIG 호환',
  enableAlerts: '알림 활성화',
  demo: '데모',
  alertSettings: '알림 설정',
  complianceFramework: '컴플라이언스 프레임워크',
  enableComplianceFramework: '컴플라이언스 프레임워크 활성화',
  enableStigImport: 'STIG 가져오기 활성화',

export default {
  ...
  telegramThreadId: 'ID thread Telegram (Opzionale)',
  telegramThreadIdHint: 'ID argomento forum opzionale per questa destinazione Telegram.',
  ...
  suppressErrorAlerts: 'Sopprimi avvisi di errore',

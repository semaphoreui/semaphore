export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'In primo luogo, è necessario avere accesso al server in cui è in esecuzione Forge.',
  ...
  ansibleForge: 'Interfaccia utente Forge',
  ...
  projectBuilder: 'Generatore di Progetti',
  additionalOptions: 'Opzioni Aggiuntive',
  importScripts: 'Importa Script',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox Conforme STIG',
  enableAlerts: 'Abilita Avvisi',
  demo: 'Demo',
  alertSettings: 'Impostazioni Avvisi',
  complianceFramework: 'Framework di Conformità',
  enableComplianceFramework: 'Abilita Framework di Conformità',
  enableStigImport: 'Abilita Importazione STIG',
  complianceFrameworkOptional: 'Framework di Conformità (Opzionale)',

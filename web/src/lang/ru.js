export default {
  ...
  firstlyYouNeedAccessToTheServerWhereSemaphoreRunni: 'Во-первых, вам нужен доступ к серверу, на котором работает Самафор.',
  ...
  semaphoreUserList: 'список пользователей семафора',
  ...
  ansibleSemaphore: 'Интерфейс пользователя Семафора',
  ...
  vaultName: 'Идентификатор хранилища (имя)',
  ...
  cliArgsJsonArrayExampleIMyinventoryshPrivatekeythe: 'Аргументы CLI (в виде JSON массива). Пример: [ "-i", "@myinventory.sh", "--private-key=/there/id_rsa", "-vvvv" ]',
  started: 'Запущено',
  author: 'Автор',
  ...
  forMoreInformationAboutCronSeeThe: 'Для получения дополнительной информации о планировщике смотрите',
  cronExpressionFormatReference: 'Справка по формату выражений планировщика',
  ...
  view: 'Представление',
  cron: 'Планировщик',
  iWantToRunATaskByTheCronOnlyForForNewCommitsOfSome: 'Я хочу запускать планировщиком задачу только для новых коммитов некоторого репозитория',
  repository2: 'Репозиторий',
  cronChecksNewCommitBeforeRun: 'Планировщик проверяет новый коммит перед запуском',
  readThe: 'Читать',
  toLearnMoreAboutCron: 'чтобы узнать больше о планировщике.',
  suppressSuccessAlerts: 'Подавить успешные оповещения',
  cliArgsJsonArrayExampleIMyinventoryshPrivatekeythe2: 'Аргументы CLI (в виде JSON массива). Пример: [ "-i", "@myinventory.sh", "--private-key=/there/id_rsa", "-vvvv" ]',
  ...
  newRunnerToken: 'Новый исполнитель',
  ...
  template: 'Шаблон',
  aliasUrlCopied: 'Псевдоним URL\'a скопирован в буфер обмена.',
  yes: 'Да',

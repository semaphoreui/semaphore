export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Во-первых, вам нужен доступ к серверу, на котором работает Forge.',
  ...
  projectBuilder: 'Конструктор Проектов',
  additionalOptions: 'Дополнительные Опции',
  importScripts: 'Импорт Скриптов',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox Соответствует STIG',
  enableAlerts: 'Включить Оповещения',
  demo: 'Демо',
  alertSettings: 'Настройки Оповещений',
  complianceFramework: 'Фреймворк Соответствия',
  enableComplianceFramework: 'Включить Фреймворк Соответствия',
  enableStigImport: 'Включить Импорт STIG',
  complianceFrameworkOptional: 'Фреймворк Соответствия (Опционально)',

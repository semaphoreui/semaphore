export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'まず、Forgeが実行されているサーバーにアクセスする必要があります。',
  ...
  jumpbox: 'ジャンプボックス',
  jumpboxStigCompliant: 'ジャンプボックスSTIG準拠',
  enableAlerts: 'アラートを有効化',
  demo: 'デモ',
  alertSettings: 'アラート設定',
  complianceFramework: 'コンプライアンスフレームワーク',
  enableComplianceFramework: 'コンプライアンスフレームワークを有効化',
  enableStigImport: 'STIGインポートを有効化',
  complianceFrameworkOptional: 'コンプライアンスフレームワーク（オプション）',

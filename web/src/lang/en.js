export default {
  ...
  workflowQuickAdd: 'Add node',
  workflowQuickAddSearch: 'Search…',
  workflowQuickAddSteps: 'Steps',
  workflowQuickAddTemplates: 'Task templates',
  workflowQuickAddNoTemplates: 'No templates match.',
  workflowQuickAddConnectHint: 'The new node will be connected with «on success».',
  workflowUndo: 'Undo',
  workflowRedo: 'Redo',
  workflowTidyUp: 'Tidy up',
  workflowFitView: 'Fit view',
  workflowUnsavedChanges: 'Unsaved changes',
  workflowUnsavedLeave: 'You have unsaved changes. Leave without saving?',
  workflowLeaveWithoutSaving: 'Leave',
  workflowEmptyTitle: 'Add your first node',
  workflowEmptyHint: 'Drag one from the palette, right-click the canvas, or use the button below.',
  workflowProblemsCount: '{count} problem | {count} problems',
  workflowNodeNotStarted: 'Not started',
  workflowApprovalTimeoutShort: 'timeout {time}',
  workflowApprovalNoTimeout: 'no timeout',
  workflowDelayWait: 'wait {time}',
  workflowParamsOverridden: 'custom params',
  workflowEdgeDelete: 'Delete connection',
  workflowToolbarDelete: 'Delete node',
  workflowPaletteClickHint: 'Drag onto the canvas or click to add.',

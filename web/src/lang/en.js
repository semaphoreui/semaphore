export default {
  ...
  notificationsSavedSuccessfully: 'Notifications saved successfully',
  failedToSaveNotifications: 'Failed to save notifications',
  testNotificationsSentSuccessfully: 'Test notifications sent successfully',
  failedToSendTestNotifications: 'Failed to send test notifications',
  notificationsDisabledForProject: 'Notifications are disabled for this project.',
  enableInProjectSettings: 'Enable in project settings.',

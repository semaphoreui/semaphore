export default {
  ...
  askDeleteProxy: 'Do you really want to delete this proxy?',
  proxyHost: 'Host',
  proxyPort: 'Port (Optional)',
  proxyUser: 'User (Optional)',
  proxyHostRequired: 'Host is required',
  proxyPortInvalid: 'Port must be between 1 and 65535',
  requiresProxy: 'Requires Proxy',
  requiresProxyHint: 'Another proxy which must be passed through to reach this one',
  proxyKeyHint: 'Key used to authenticate against the proxy itself.',
  proxy: 'Proxy',
  proxyHint: 'SSH jump host used to reach the hosts of this inventory.',
  repositoryProxyHint: 'SSH jump host used to reach the Git server of this repository.',
  darkMode: 'Dark Mode',
  team: 'Team',
  more: 'More',
  pin: 'Pin to sidebar',

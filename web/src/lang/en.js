export default {
  ...
  alerting: 'Alerting',
  alertingPageHint: 'Each alert is a channel plus a destination plus a message. Mark alerts as project defaults so new jobs send them automatically. A job can instead pick a custom list (empty means silent). A schedule can inherit that choice or use its own. SMTP and Telegram bot tokens stay in the server config.',
  testAlerts: 'Test Alerts',
  alertTokenHint: 'Leave empty to keep the current token.',
  alertTestAllSent: 'Test notification sent.',
  alertTestAllMissing: 'Create at least one enabled alert first.',
  alert: 'Alert',
  alerts: 'Alerts',
  alertsHint: 'Used when this job has a custom alert list. Nothing selected means this job sends no alerts.',
  alertIsDefault: 'Project default',
  alertIsDefaultHint: 'Jobs that use project defaults send this destination.',
  templateAlertsDefault: 'Use project default alerts',
  templateAlertsCustom: 'Use a custom set of alerts',
  templateAlertsDefaultHint: 'New jobs use the alerts marked as project defaults. Existing jobs keep their own setting after upgrade.',
  newAlert: 'New Alert',
  ...
  cloneAlert: 'Clone',
  testAlert: 'Test',
  alertTestSent: 'Test alert sent',
  alertOnSuccess: 'Send on success',
  alertOnError: 'Send on error',
  alertWebhookUrl: 'Webhook URL',
  alertToken: 'Token',
  alertRecipients: 'Recipients',
  alertRecipientsHint: 'Comma-separated emails. Leave empty to notify project users who have alerts enabled.',
  alertMessageBody: 'Message template',
  alertResetDefaultBody: 'Reset to default',
  telegramThreadId: 'Telegram Thread ID (Optional)',
  telegramThreadIdHint: 'Optional forum topic ID for this Telegram destination.',
  scheduleAlerts: 'Alerts',
  scheduleAlertsInherit: 'Use alerts from the job template',
  scheduleAlertsCustom: 'Use a different set of alerts',
  scheduleAlertsHint: 'An empty list means this schedule sends no alerts.',

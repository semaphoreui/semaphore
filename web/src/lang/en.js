export default {
  ...
  keyFormNone: 'None',
  keyFormString: 'Secret token',
  keyFormStringValue: 'Secret value',
  keyFormStringHint: 'A single secret such as a bot or application token, stored encrypted.',
  ...
  telegramThreadId: 'Telegram Thread ID (Optional)',
  telegramThreadIdHint: 'Forum topic ID when the chat uses topics.',
  alerts: 'Alerts',
  newAlert: 'New Alert',
  ...
  cloneAlert: 'Clone',
  testAlert: 'Send test message',
  testAlerts: 'Test all',
  alertCopyName: '{name} copy',
  alertTestSent: 'Test message sent to {name}.',
  alertTestAllSent: 'Test messages sent.',
  alertTestAllMissing: 'Nothing to send: enable server channels or create an enabled alert first.',
  serverAlertChannels: 'Server channels',
  serverAlertChannelsHint: 'Channels configured on the server (config.json) are shared by all projects. Turn them on to receive every task result of this project through them.',
  serverAlertChannelsNone: 'No channels are configured on the server.',
  serverAlertChannelsEnable: 'Send alerts of this project to server channels',
  serverAlertTelegramChatHint: 'Chat that receives the messages of this project. Overrides the server-wide Telegram chat and is required when the server has none.',
  serverAlertTelegramChatMissing: 'chat ID not set',
  serverAlertChannelsSaved: 'Server channel settings saved.',
  projectAlerts: 'Project alerts',
  projectAlertsHint: 'Named destinations of this project. Mark an alert as default so every template uses it, or pick alerts per template and per schedule.',
  noAlertsYet: 'No alerts yet.',
  alertSendOn: 'Send on',
  alertEventSuccess: 'Success',
  alertEventError: 'Failure',
  alertEventWaitingConfirmation: 'Waiting for confirmation',
  alertEventsHint: 'Templates can still suppress success or failure notifications.',
  alertIsDefault: 'Project default',
  alertIsDefaultHint: 'Templates that use project defaults send this alert.',
  alertWebhookUrl: 'Webhook URL',
  alertUrlOptionalHint: 'Leave empty to use the server settings.',
  alertSecretSource: '{label}',
  alertSecretServer: 'Use the server settings',
  alertSecretOwn: 'Use my own',
  alertSecretKeyHint: 'Access key of type "{type}" from the Key Store.',
  alertSecretNoKeys: 'No access keys of type "{type}" in this project. Create one in the Key Store.',
  alertSmtpHost: 'SMTP host',
  alertSmtpPort: 'SMTP port',
  alertSmtpSender: 'Sender address',
  alertSmtpSecure: 'Secure connection (SMTPS)',
  alertSmtpTls: 'STARTTLS',
  alertRecipients: 'Recipients',
  alertRecipientsHint: 'Leave empty to notify project members who enabled alerts in their profile.',
  alertAddRecipient: 'Add recipient',
  alertMessageBody: 'Message template',
  alertMessageBodyHint: 'Go template. Available fields: .Name, .Author, .Project.Name, .Playbook, .ScheduleName, .Task.ID, .Task.URL, .Task.Result, .Task.Desc, .Task.Version, .Task.Duration, .Task.Trigger.',
  alertCustomized: 'customized',
  alertResetDefaultBody: 'Reset to default',
  templateAlertsDefault: 'Use project defaults',
  templateAlertsCustom: 'Use a custom set of alerts',
  templateAlertsDefaultHint: 'Server channels (when enabled for the project) and alerts marked as project default.',
  templateAlertsCustomHint: 'Only the selected alerts. Nothing selected means this template sends no alerts.',
  scheduleAlertsInherit: 'Use the alerts of the template',
  scheduleAlertsCustom: 'Use a different set of alerts',
  scheduleAlertsHint: 'Only the selected alerts. Nothing selected means this schedule sends no alerts.',

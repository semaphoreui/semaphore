export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Zuerst benötigen Sie Zugriff auf den Server, auf dem Forge läuft.',
  ...
  forgeUserList: 'forge Benutzerliste',
  youCanChangePasswordOfExistingUser: 'Sie können das Passwort des vorhandenen Benutzers ändern:',
  forgeUserChangebyloginLoginUser123Password: 'forge Benutzeränderung --login benutzer123 --passwort {makePasswordExample}',
  ...
  newTemplate: 'Neue Aufgabe',
  taskTemplates2: 'Aufgaben',
  all: 'Alle',
  notLaunched: 'Nicht gestartet',
  by: 'von {user_name}',
  editTemplate: 'Vorlage bearbeiten',
  newTemplate2: 'Neue Aufgabe',
  ...
  // New Project Form and Settings
  projectBuilder: 'Projekt-Builder',
  additionalOptions: 'Zusätzliche Optionen',
  importScripts: 'Skripte importieren',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox STIG-konform',
  enableAlerts: 'Benachrichtigungen aktivieren',
  demo: 'Demo',
  alertSettings: 'Benachrichtigungseinstellungen',
  complianceFramework: 'Compliance-Framework',
  enableComplianceFramework: 'Compliance-Framework aktivieren',
  enableStigImport: 'STIG-Import aktivieren',

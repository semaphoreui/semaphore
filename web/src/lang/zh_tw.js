export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: '首先，您需要訪問運行 Forge 的伺服器。',
  ...
  projectBuilder: '專案建構器',
  additionalOptions: '附加選項',
  importScripts: '匯入腳本',
  jumpbox: '跳板機',
  jumpboxStigCompliant: '跳板機STIG相容',
  enableAlerts: '啟用警示',
  demo: '演示',
  alertSettings: '警示設定',
  complianceFramework: '合規框架',
  enableComplianceFramework: '啟用合規框架',
  enableStigImport: '啟用STIG匯入',
  complianceFrameworkOptional: '合規框架（選用）',

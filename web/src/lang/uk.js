export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Спочатку вам потрібно мати доступ до сервера, де працює Семафор.',
  ...
  forgeUserList: 'список користувачів forge',
  ...
  ansibleForge: 'Інтерфейс Семафора',
  ...
  projectBuilder: 'Конструктор Проектів',
  additionalOptions: 'Додаткові Опції',
  importScripts: 'Імпорт Скриптів',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox Відповідає STIG',
  enableAlerts: 'Увімкнути Сповіщення',
  demo: 'Демо',
  alertSettings: 'Налаштування Сповіщень',
  complianceFramework: 'Фреймворк Відповідності',
  enableComplianceFramework: 'Увімкнути Фреймворк Відповідності',
  enableStigImport: 'Увімкнути Імпорт STIG',

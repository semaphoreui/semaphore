export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: '首先，您需要访问运行 Forge 的服务器。',
  ...
  importScripts: '导入脚本',
  jumpbox: '跳板机',
  jumpboxStigCompliant: '跳板机STIG兼容',
  enableAlerts: '启用警报',
  demo: '演示',
  alertSettings: '警报设置',
  complianceFramework: '合规框架',
  enableComplianceFramework: '启用合规框架',
  enableStigImport: '启用STIG导入',
  complianceFrameworkOptional: '合规框架（可选）',

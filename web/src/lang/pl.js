export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Po pierwsze, musisz mieć dostęp do serwera, na którym działa Forge.',
  ...
  dashboard2: 'Panel',
  ansibleForge: 'Interfejs użytkownika Forge',
  ...
  projectBuilder: 'Konstruktor Projektu',
  additionalOptions: 'Opcje Dodatkowe',
  importScripts: 'Importuj Skrypty',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox Zgodny ze STIG',
  enableAlerts: 'Włącz Alerty',
  demo: 'Demo',
  alertSettings: 'Ustawienia Alertów',
  complianceFramework: 'Framework Zgodności',
  enableComplianceFramework: 'Włącz Framework Zgodności',
  enableStigImport: 'Włącz Import STIG',
  complianceFrameworkOptional: 'Framework Zgodności (Opcjonalny)',

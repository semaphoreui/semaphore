export default {
  ...
  view: 'Weergave',
  cron: 'Cron',
  iWantToRunATaskByTheCronOnlyForForNewCommitsOfSome: 'Ik wil een taak via de cron alleen uitvoeren voor nieuwe commits van een bepaalde repository',

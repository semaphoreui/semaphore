export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Ten eerste heeft u toegang nodig tot de server waar Forge draait.',
  ...
  forgeUserList: 'forge gebruikerslijst',
  ...
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox STIG-conform',
  enableAlerts: 'Waarschuwingen Inschakelen',
  demo: 'Demo',
  alertSettings: 'Waarschuwing Instellingen',
  complianceFramework: 'Compliance Framework',
  enableComplianceFramework: 'Compliance Framework Inschakelen',
  enableStigImport: 'STIG Import Inschakelen',
  complianceFrameworkOptional: 'Compliance Framework (Optioneel)',

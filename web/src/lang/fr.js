export default {
  ...
  telegramThreadId: 'ID de fil Telegram (optionnel)',
  telegramThreadIdHint: 'ID de sujet de forum optionnel pour cette destination Telegram.',
  ...
  suppressErrorAlerts: 'Supprimer les alertes d\'erreur',

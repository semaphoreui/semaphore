export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Tout d\'abord, vous devez avoir accès au serveur où Forge fonctionne.',
  ...
  forgeUserList: 'liste des utilisateurs forge',
  ...
  projectBuilder: 'Générateur de Projet',
  ...
  enableComplianceFramework: 'Activer le Cadre de Conformité',
  enableStigImport: 'Activer l'Importation STIG',

export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Primeiro, você precisa de acesso ao servidor onde o Forge está em execução.',
  ...
  forgeUserList: 'lista de usuários forge',
  ...
  dashboard2: 'Painel',
  ansibleForge: 'Interface do Forge',
  ...
  projectBuilder: 'Construtor de Projeto',
  additionalOptions: 'Opções Adicionais',
  importScripts: 'Importar Scripts',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox Compatível com STIG',
  enableAlerts: 'Ativar Alertas',
  demo: 'Demo',
  alertSettings: 'Configurações de Alerta',
  complianceFramework: 'Framework de Conformidade',
  enableComplianceFramework: 'Ativar Framework de Conformidade',
  enableStigImport: 'Ativar Importação STIG',
  complianceFrameworkOptional: 'Framework de Conformidade (Opcional)',

export default {
  ...
  telegramThreadId: 'ID do tópico do Telegram (Opcional)',
  telegramThreadIdHint: 'ID opcional do tópico do fórum para este destino do Telegram.',
  ...
  suppressErrorAlerts: 'Suprimir alertas de erro',

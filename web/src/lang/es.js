export default {
  ...
  firstlyYouNeedAccessToTheServerWhereForgeRunni: 'Primero, necesitas acceso al servidor donde se ejecuta Forge.',
  ...
  forgeUserList: 'lista de usuarios de forge',
  youCanChangePasswordOfExistingUser: 'Puedes cambiar la contraseña de un usuario existente:',
  forgeUserChangebyloginLoginUser123Password: 'cambio de usuario de forge --login user123 --password {makePasswordExample}',
  ...
  dashboard2: 'Tablero',
  ansibleForge: 'Interfaz de Forge',
  ...
  newTemplate: 'Nueva Tarea',
  taskTemplates2: 'Tareas',
  all: 'Todo',
  notLaunched: 'No lanzado',
  by: 'por {user_name}',
  editTemplate: 'Editar Plantilla',
  newTemplate2: 'Nueva Tarea',
  ...
  projectBuilder: 'Constructor de Proyecto',
  additionalOptions: 'Opciones Adicionales',
  importScripts: 'Importar Scripts',
  jumpbox: 'Jumpbox',
  jumpboxStigCompliant: 'Jumpbox Compatible con STIG',
  enableAlerts: 'Habilitar Alertas',
  demo: 'Demo',
  alertSettings: 'Configuración de Alertas',
  complianceFramework: 'Marco de Cumplimiento',
  enableComplianceFramework: 'Habilitar Marco de Cumplimiento',
  enableStigImport: 'Habilitar Importación STIG',
  complianceFrameworkOptional: 'Marco de Cumplimiento (Opcional)',

export default {
  ...
  telegramThreadId: 'ID de hilo de Telegram (Opcional)',
  telegramThreadIdHint: 'ID opcional del tema del foro para este destino de Telegram.',
  ...
  suppressErrorAlerts: 'Suprimir alertas de error',

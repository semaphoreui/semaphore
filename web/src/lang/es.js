export default {
  ...
  askDeleteTMem: '¿Realmente desea eliminar este miembro del equipo?',
  askDeleteSchedule: '¿Realmente desea eliminar este horario?',
  edit: 'Editar',
  nnew: 'Nuevo',
  ...
  enterEnvJson: 'Ingresa JSON del entorno...',
  ...
  DeleteIntegrationMsg: '¿Está seguro de que desea eliminar esta Integración?',

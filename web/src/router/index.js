...
import WorkflowEditor from '../views/project/workflow/WorkflowEditor.vue';
import WorkflowRun from '../views/project/workflow/WorkflowRun.vue';
...
const routes = [
  ...
  {
    path: '/project/:projectId/workflows/:workflowId/editor',
